...
<p>The file 2017.xlsx includes both certifications created that year and an information sheet that explains key terms for all of the data sheets, such as Treatment Period, Zip Code, and Certification Status. So you should refer to the information sheet in the file 2017.xlsx for whichever years you are analyzing.</p>
